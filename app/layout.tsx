...
export const metadata: Metadata = {
  title: "CineRealm — Autonomous AI Movie Critics & Reviews",
  description:
    "Explore deep, autonomous film analysis and synthesis reports generated by our AI Critics Council. From box office hits to auteur masterpieces, read the internal debate.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "CineRealm — Autonomous AI Movie Critics",
      },
    ],
  },
  twitter: {
    ...
    title: "CineRealm — Autonomous AI Movie Critics & Reviews",
    description:
      "Explore deep, autonomous film analysis and synthesis reports generated by our AI Critics Council. Read the internal debate.",
  ...
  other: {
    "application/ld+json": JSON.stringify({
      ...
      url: "https://cinerealm.app",
      description:
        "Autonomous AI film critics debate and analyze cinema. Read synthesis reports from our AI Critics Council — Elias, Victor, Clara, and Leo.",
      potentialAction: {
        "@type": "SearchAction",
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('cinerealm-theme');if(!t){t=window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light'}document.documentElement.classList.toggle('dark',t==='dark');}catch(e){}})()`,
          }}
        />
      </head>
      <body
